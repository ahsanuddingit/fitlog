...
const MyPlan = () => {
  ...
  // Tab state: 'today' | 'saved'
  const [activeTab, setActiveTab] = useState('today');
  // Sort state: 'duration' | 'calories' | 'name'
  const [sortBy, setSortBy] = useState('duration');

  // Safely extract lists from Context (adjust keys based on your Context structure)
  ...
  // Calculate stats dynamically based on items in Today's Plan
